<?php
	echo '<h1 align = "center">Problem 3: Watermelon</h1>' ;
	...
	$sql = "SELECT ID, dt, tm, file_name, verdict FROM sub_info where username='$user' and problem=3" ;				//change this for diff problem
	$result = $db->query($sql) ;
